( () => {
    ...
    var p;
    function D(e, o, t) {
        if (!e || sessionStorage.getItem("waifu-text") && sessionStorage.getItem("waifu-text") > t)
            return;
        p && (clearTimeout(p),
        p = null),
        e = g(e),
    ...
    function E(e) {
        ...
        function t(s) {
            ...
            s.seasons.forEach( ({date: w, text: d}) => {
                let n = new Date
                  , f = w.split("-")[0]
                  , r = w.split("-")[1] || f;
                f.split("/")[0] <= n.getMonth() + 1 && n.getMonth() + 1 <= r.split("/")[0] && f.split("/")[1] <= n.getDate() && n.getDate() <= r.split("/")[1] && (d = g(d),
        ...
        function c() {
            if (e.dragEnable === !1)
                return;
            let s = document.getElementById("waifu"), i = document.getElementById("live2d"), l = !1, m, h, w, d;
    ...
    function B(e, o) {
        ...
        t.addEventListener("click", () => {
            ...
            t.getAttribute("first-time") ? (E(e),
            t.removeAttribute("first-time")) : (localStorage.removeItem("waifu-display"),
        ...
        localStorage.getItem("waifu-display") && Date.now() - localStorage.getItem("waifu-display") <= 864e5 ? (t.setAttribute("first-time", !0),
        setTimeout( () => {
    ...
    function H() {
        ...
        if (document.referrer !== "") {
            ...
            return location.hostname === t.hostname ? e : (c in s ? o = s[c] : o = t.hostname,
